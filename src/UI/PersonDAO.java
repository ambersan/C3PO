...
public class PersonDAO{      
	...
	//class to query the database for contact information and pass it to a PersonInfo object 
	...
	public ArrayList searchPerson(String name)
	{
		try	{
			...
			while(rs.next())
			{
				...
				PersonInfo person = new PersonInfo(id, pname, address, phone, cell, email);
